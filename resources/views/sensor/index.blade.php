...
<div class="content m-1" id="tab-group-3">
  ...
  <div data-bs-parent="#tab-group-3" class="collapse" id="tab-2-sensor">
    {{--  <div class="content mb-0">
      <div class="row mb-2">
        <div class="col-8">
          <h4 class="font-700 text-uppercase font-12 opacity-30 mb-1 mt-2">List of Sensors</h4>
        </div>
        <div class="col-4" style="text-align:right">
  ...
  <div class="content mt-2">
    ...
    <form class="needs-validation" id="addTerrainForm" novalidate>
      <div class="input-style input-style-always-active has-borders mb-4">
        <input id="sensorName" type="name" class="form-control" placeholder="Enter sensor name" required>
        <label class="color-theme opacity-50 text-uppercase font-700 font-10">Sensor Name</label>
        <em>(required)</em>
      </div>

      <div class="input-style input-style-always-active has-borders mb-4">
        <textarea name="sensorDesc" class="form-control" id="sensorDesc" cols="30" rows="10"
