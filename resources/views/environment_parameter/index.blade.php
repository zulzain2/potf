<div id="environment_parameter"></div>
    ...
    <div class="row mb-2">
        ...
        <div class="col-4" style="text-align:right">
            <a href="#" id="btn-menu-add-terrain-parameter"
                class="btn btn-m btn-full mb-3 rounded-xl text-uppercase font-900 shadow-s bg-highlight">ADD</a>
        </div>
    </div>
...
@push('content2')
    ...
    <div id="menu-terrain-parameter" class="col-4 menu menu-box-bottom rounded-0" data-menu-effect="menu-over"
        data-menu-height="250" style="padding-left: 70px;background-color: transparent !important;">
        <div class="card card-style me-2 border-highlight"
            style="overflow: scroll;margin: 0;border-radius: 0px;height: 250px;border-top-style: groove !important;border-top-width: 13px !important;">
            <div class="content me-1 ms-1 h-100">
                <div class="menu-title mt-n1">
                    <a href="#" class="close-menu color-invert" style="line-height:55px !important"><i
                            class="fa fa-times font-14"></i></a>
                </div>
